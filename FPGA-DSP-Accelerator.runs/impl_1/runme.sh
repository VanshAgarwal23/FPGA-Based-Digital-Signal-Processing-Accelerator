...
HD_PWD='C:/Users/Test/Vivado_projects/FPGA-DSP-Accelerator/FPGA-DSP-Accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_accelerator_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dsp_accelerator_top.tcl -notrace
