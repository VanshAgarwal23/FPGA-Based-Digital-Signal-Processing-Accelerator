...
HD_PWD='C:/Users/Test/Vivado_projects/FPGA-DSP-Accelerator/FPGA-DSP-Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_accelerator_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_accelerator_top.tcl
